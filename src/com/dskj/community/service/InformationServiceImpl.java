...
public class InformationServiceImpl extends Base implements InformationService {
	...
	public Integer addInformation(String userId,String title, String context,
	...
	public void updateInformation(int infoId,String title, String context, String imgUrl)
			throws Exception {
		informationMapper.update(title,context,infoId);
		informationImgMapper.delete(infoId);
		if (imgUrl != null) {
			List<InformationImg> informationImgs = new ArrayList<InformationImg>();
			InformationImg informationImg = new InformationImg();
