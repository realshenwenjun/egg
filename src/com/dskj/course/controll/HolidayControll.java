...
public class HolidayControll extends Base {
    ...
    public void addLack(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    public void deleteLack(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("holiday");
        logger.info(jsonString);
    ...
    public void getCourseClassTeacherList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("holiday");
        logger.info(jsonString);
    ...
    public void getClassPlanLackList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("holiday");
        logger.info(jsonString);
    ...
    public void getManageClassTeacherList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("holiday");
        logger.info(jsonString);
    ...
    public void getClassTeacherPlanLackList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("holiday");
        logger.info(jsonString);
        List<ClassPlanLackList> classPlanLackLists = holidayService.getClassPlanLackList(readTree(jsonString, "userId"), readTreeAsInt(jsonString, "classId"));
        write(response, null, null, null, classPlanLackLists);
