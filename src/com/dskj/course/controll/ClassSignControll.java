...
public class ClassSignControll extends Base {
    ...
    public void addUserToClass(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    public void deleteUserFromClass(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("csign");
        logger.info(jsonString);
    ...
    public void getUsersFromClass(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("csign");
        logger.info(jsonString);
    ...
    public void getUnSignUsersByName(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("csign");
        logger.info(jsonString);
    ...
    public void getMyUsersByName(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("csign");
        logger.info(jsonString);
