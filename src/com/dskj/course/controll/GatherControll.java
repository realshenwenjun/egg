...
public class GatherControll extends Base {
    ...
    public void getGatherCourseClassPlans(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    public void getTeacherGatherCourseClassPlans(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("gather");
        logger.info(jsonString);
    ...
    public void getManageCourseClassCount(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("gather");
        logger.info(jsonString);
    ...
    public void getManageClassUserCountDate(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("gather");
        logger.info(jsonString);
