...
public class AdminCourseControll extends Base {
    ...
    public void getCourseTypeOf(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    public void addCourseTypeOf(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("admin");
        logger.info(jsonString);
    ...
    public void updateCourseTypeOf(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("admin");
        logger.info(jsonString);
    ...
    public void deleteCourseTypeOf(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("admin");
        logger.info(jsonString);
    ...
    public void getCourseTypeOfList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("admin");
        logger.info(jsonString);
    ...
    public void getCourseType(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("admin");
        logger.info(jsonString);
    ...
    public void addCourseType(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    public void updateCourseType(HttpServletRequest request, HttpServletResponse response) throws Exception {
        CourseType courseType = null;
        String jsonString = request.getParameter("admin");
        logger.info(jsonString);
        courseType = stringToObj(jsonString, CourseType.class);
    ...
    public void deleteCourseType(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("admin");
        logger.info(jsonString);
    ...
    public void getCourseTypeList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jsonString = request.getParameter("admin");
        logger.info(jsonString);
