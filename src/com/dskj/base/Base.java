...
public abstract class Base {
	...
	public static String netKey = "ZjM1ZTZhMzctYTA1Ny00NjJiLWI0ODctMTc4YTI2NGUxYzFk";
	...
	public boolean readTreeAsBoolean(String json, String key) throws JsonProcessingException, IOException {
		rootNode = objectMapper.readTree(json);
		boolean cJson = rootNode.path(key).getValueAsBoolean();
		return cJson;
	}
}
